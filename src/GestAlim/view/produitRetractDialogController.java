 ...
 * @author Marco Jakob
 */
public class produitRetractDialogController {

    @FXML
    private JFXTextField QuantiteField;
    @FXML
    private JFXTextField MotifRetraitField;
    ...
    private void handleOk() {
            ...
            EvolutionController.addElementProduitEvolution(0,new ProduitEvolution(p),"Retrait",MainApp.userActuel.getNomEmployee(), MotifRetraitField.getText());
    ...
    private boolean isInputValid() {
        ...
        if (MotifRetraitField.getText() == null || MotifRetraitField.getText().length() == 0) {
            errorMessage += "Le motif de retrait est invalide!\n";
        }
